...
INSERT INTO public.template VALUES (1, 1, 'Bonjour {{customerFirstname}}, je suis {{agentFirstname}} {{agentLastname}}, votre conseiller chez {{companyNameShort}}, je me permets de vous contacter pour qu''on puisse discuter de votre contrat. Envoyez moi un message dès que vous êtes disponible. Merci.', true, false);
...
INSERT INTO public.template VALUES (4, 3, 'Je vous remercie de m''avoir contacté, {{customerFirstname}}. Si vous avez d''autres questions, n''hésitez à me recontacter sur ce même numéro. {{agentFirstname}} de chez {{companyNameShort}}.', false, false);